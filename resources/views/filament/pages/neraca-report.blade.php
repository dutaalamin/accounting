<x-filament-panels::page>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <!-- Total Aset -->
        <div class="relative overflow-hidden rounded-2xl bg-white dark:bg-gray-900 p-6 shadow-sm ring-1 ring-gray-950/5 dark:ring-white/10 transition duration-300 hover:shadow-md">
                            ...
                            @if(abs($balance) > 0)
                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/30 transition">
                                    <td class="px-4 py-3 text-gray-700 dark:text-gray-300">
                                        <span class="font-mono text-xs text-gray-400 bg-gray-100 dark:bg-gray-800 px-1.5 py-0.5 rounded mr-2">{{ $account->code }}</span>
                                        {{ $account->name }}
                                    </td>
                ...
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-white/5">
                        ...
                        <tr class="bg-gray-100/50 dark:bg-gray-800/30">
                            <td colspan="2" class="px-4 py-2 text-xs font-bold uppercase tracking-wider text-rose-600 dark:text-rose-400">
                        ...
                        <!-- MODAL HEADER -->
                        <tr class="bg-gray-100/50 dark:bg-gray-800/30">
                            <td colspan="2" class="px-4 py-2 text-xs font-bold uppercase tracking-wider text-indigo-600 dark:text-indigo-400 border-t border-gray-100 dark:border-white/5">
                                Modal (Ekuitas)
                            </td>
                        </tr>
                        ...
                        @if(abs($this->currentYearIncome()) > 0)
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/30 transition">
                                <td class="px-4 py-3 text-gray-700 dark:text-gray-300">
                                    <span class="font-mono text-xs text-gray-400 bg-gray-100 dark:bg-gray-800 px-1.5 py-0.5 rounded mr-2">399</span>
