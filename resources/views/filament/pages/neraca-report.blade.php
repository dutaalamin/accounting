<x-filament-panels::page>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <!-- Total Aset -->
        <div
            class="relative overflow-hidden rounded-2xl bg-white dark:bg-gray-900 p-6 shadow-sm ring-1 ring-gray-950/5 dark:ring-white/10 transition duration-300 hover:shadow-md">
    ...
    @endphp
    <div
        class="rounded-xl p-4 border transition duration-300 {{ $balanced ? 'bg-emerald-50 dark:bg-emerald-950/10 border-emerald-200 dark:border-emerald-500/20 text-emerald-800 dark:text-emerald-300' : 'bg-rose-50 dark:bg-rose-950/10 border-rose-200 dark:border-rose-500/20 text-rose-800 dark:text-rose-300' }}">
        <div class="flex items-center gap-3">
            <div
                class="p-1 rounded-full {{ $balanced ? 'bg-emerald-200/50 dark:bg-emerald-500/20' : 'bg-rose-200/50 dark:bg-rose-500/20' }}">
            ...
            <div>
                ...
                <span
                    class="text-xs">{{ $balanced ? 'Sempurna! Neraca dalam keadaan seimbang (Aset = Kewajiban + Modal).' : 'Perhatian! Neraca saat ini tidak seimbang. Silakan periksa kembali entri jurnal harian.' }}</span>
            </div>
        </div>
    </div>
                ...
                <table class="w-full text-sm">
                    <thead class="bg-gray-50 dark:bg-gray-800/50">
                        <tr class="text-left text-gray-500 dark:text-gray-400">
                            ...
                            <th class="px-4 py-3 font-semibold text-xs uppercase tracking-wider text-right">Saldo</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-gray-100 dark:divide-white/5">
                            ...
                            @if(abs($balance) > 0)
                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/30 transition">
                                    <td class="px-4 py-3 text-gray-700 dark:text-gray-300">
                                        <span
                                            class="font-mono text-xs text-gray-400 bg-gray-100 dark:bg-gray-800 px-1.5 py-0.5 rounded mr-2">{{ $account->code }}</span>
                                        {{ $account->name }}
                                    </td>
                        ...
                        <tr class="bg-emerald-50/50 dark:bg-emerald-950/10 font-bold border-t border-emerald-200">
                            <td class="px-4 py-3 text-emerald-700 dark:text-emerald-400">Total Aset</td>
                            <td class="px-4 py-3 text-right text-emerald-700 dark:text-emerald-400 text-base">
                                Rp {{ number_format($totalAsset, 0, ',', '.') }}
                            </td>
                        </tr>
                    </tbody>
                ...
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-white/5">
                        ...
                        <tr class="bg-gray-100/50 dark:bg-gray-800/30">
                            <td colspan="2"
                                class="px-4 py-2 text-xs font-bold uppercase tracking-wider text-rose-600 dark:text-rose-400">
                        ...
                        <tr class="bg-rose-50/30 dark:bg-rose-950/10 font-bold">
                            <td class="px-4 py-3 text-rose-700 dark:text-rose-400 pl-6 text-xs">Total Kewajiban</td>
                            <td class="px-4 py-3 text-right text-rose-700 dark:text-rose-400 pl-6">
                                Rp {{ number_format($totalLiability, 0, ',', '.') }}
                            </td>
                        </tr>
                        ...
                        <tr class="bg-gray-100/50 dark:bg-gray-800/30">
                            <td colspan="2"
                                class="px-4 py-2 text-xs font-bold uppercase tracking-wider text-indigo-600 dark:text-indigo-400 border-t border-gray-100 dark:border-white/5">
                                Modal (Ekuitas)
                            </td>
                        </tr>
                        ...
                        @if(abs($this->currentYearIncome()) > 0)
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/30 transition">
                                <td class="px-4 py-3 text-gray-700 dark:text-gray-300">
                                    <span
                                        class="font-mono text-xs text-gray-400 bg-gray-100 dark:bg-gray-800 px-1.5 py-0.5 rounded mr-2">399</span>
                        ...
                        <tr class="bg-indigo-50/30 dark:bg-indigo-950/10 font-bold">
                            <td class="px-4 py-3 text-indigo-700 dark:text-indigo-400 pl-6 text-xs">Total Modal</td>
                            <td class="px-4 py-3 text-right text-indigo-700 dark:text-indigo-400 pl-6">
                                Rp {{ number_format($totalEquity, 0, ',', '.') }}
                            </td>
                        </tr>
                        ...
                        <!-- GRAND TOTAL -->
                        <tr
                            class="bg-gray-100 dark:bg-gray-800 font-bold border-t-2 border-gray-300 dark:border-white/20">
